...
// To insert new row to the table employees
	public static int insertEmployees(Employees newemp) {
...
// for updating all the columns of the table
	public static int updateEmployees(Employees newemp) {
	...
	public static int updateEmployeesFirstName(int id, String fname) {
	...
	public static int updateEmployeesSalary(int id, float salary) {
	...
	public static int deleteEmployees(int id) {
